...
import { fieldLabelClass, inputClass, pageTitleClass } from "../ui/styles";
...
export function RegisterForm({ submitting, error: _error, onSubmit }: RegisterFormProps) {
  const { t } = useI18n();
      ...
      <form className="flex w-full flex-col" onSubmit={handleSubmit}>
        ...
        <div style={{ marginTop: "-60px" }}>
          ...
          <div className="mt-5 grid gap-4 sm:mt-6">
            ...
            {/* Backend auth error intentionally hidden on register screen */}
          </div>
          ...
          <Button
            ...
            disabled={submitting}
          >
            {submitting ? t("register.submitting") : t("common.continue")}
          </Button>
        </div>
      </form>
    </section>
